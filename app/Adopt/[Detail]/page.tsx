...
function PetDetail({ params }: { params: { Detail: string } }) {
  ...
  if (data.petName)
    return (
      <>
        ...
        <form className="w-full mr-4 mt-4 p-4" key={data._id}>
          <div className="flex flex-row justify-center">
            <div className="w-[400px] h-[400px] bg-gray-300 rounded-md justify-center mr-4">
              <img
                src={data.image.url}
                alt=""
            ...
            <div
              className="flex items-center justify-center border-solid rounded-md border-[1px] border-sky-500 p-8 w-[500px] overflow-auto hover:border-yellow-500 hover:shadow-lg  ml-6 "
            ...
            >
              ...
              <div className=" justify-self-center p-6">
                <div className="font-montserrat font-bold text-2xl text-center">
                  {data.petName}
                </div>
  ...
  if (!data.petName && !notFound)
    return (
      <LoadingModal
        isLoading={true}
        isComplete={false}
        setIsComplete={setIsComplete}
        loadWhat="LOADING_PET_INFO"
      />
    );
