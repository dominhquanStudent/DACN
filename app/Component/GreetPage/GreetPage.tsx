  ...
  return (
    <>
      ...
      <div className="flex flex-col w-screen">
        ...
        >
          <div className="text-3xl md:text-5xl font-nunito">Chào mừng đến với </div>
          <div className="text-3xl md:text-5xl font-nunito"> BKPetcare</div>
          <img
            loading="lazy"
            src={Doggo1.src}
            className="w-[200px] h-[300px] md:w-[300px] md:h-[500px]"
            alt="Doggo1"
          ></img>
          {/*word container*/}
          <div className="text-center px-4 md:px-0">
            <div className="text-3xl md:text-5xl font-bold font-nunito">
              Gâu Gâu
            </div>
            <div className="text-3xl md:text-5xl font-bold font-nunito">
        ...
        {/* mid container */}
        <div
          className={`flex flex-col mt-10 mx-4 md:mx-32 items-center ${
            activeContainer >= 2
              ? "opacity-100 transition-opacity duration-500"
              : "opacity-0 transition-opacity duration-500"
          }`}
        >
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-[50%] flex flex-col items-center text-center md:text-left">
              <div className="text-2xl md:text-4xl font-bold font-k2d mb-4">
                Chúng tôi coi thú cưng của bạn như người nhà
              </div>
              <div className="text-lg md:text-xl font-montserrat">
            ...
            <div className="w-full md:w-[50%] mt-4 md:mt-0">
              <img loading="lazy" src={Service.src} alt="Service" />
            </div>
          </div>
          {/* Dịch vụ */}
          <div className="flex flex-col md:flex-row items-center mt-10">
            ...
            <div className="w-full md:w-[50%] order-2 md:order-1 mt-4 md:mt-0">
              <img loading="lazy" src={Healthcare.src} alt="Healthcare" />
            </div>
            ...
            <div className="w-full md:w-[50%] order-1 md:order-2 flex flex-col items-center text-center md:text-left">
              ...
              <div className="flex flex-col md:flex-row mt-4 justify-center">
                <Link href="/Adopt">
                  <button
                    className="transition ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 w-full md:w-auto flex justify-center items-center p-3 space-x-4 font-sans font-bold text-white rounded-full shadow-lg bg-cyan-700 shadow-cyan-100 hover:bg-opacity-90 mt-4 md:mt-0"
                  >
                ...
                <Link href="/Rescue">
                  <button
                    className="transition ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 w-full md:w-auto flex justify-center items-center p-3 space-x-4 font-sans font-bold text-white rounded-full shadow-lg bg-cyan-700 shadow-cyan-100 hover:bg-opacity-90 mt-4 md:mt-0 md:ml-4"
                  >
          ...
          <div className="flex flex-col md:flex-row items-center mt-10">
            ...
            <div className="w-full md:w-[50%] mt-4 md:mt-0">
              <img loading="lazy" src={Consult.src} alt="Consult" />
            </div>
          </div>
        </div>
        {/* Bottom Container */}
        ...
        >
          <div className="text-2xl md:text-4xl font-bold font-k2d max-w-[90%] md:max-w-[50%] text-center mb-4">
